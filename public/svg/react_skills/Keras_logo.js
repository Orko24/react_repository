...
export default function Keras_logo(props) {
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1080 1080" style={{enableBackground: 'new 0 0 1080 1080'}} xmlSpace="preserve" width={1080} height={1080} {...props}>
      <style type="text/css" dangerouslySetInnerHTML={{__html: "\n\t.st0{fill:#FFFFFF;}\n\t.st1{fill:#D00000;}\n" }} />
      <g>
        <path className="st0" d="M1080,1079.96c0,0.02-0.02,0.04-0.04,0.04H0.04c-0.02,0-0.04-0.02-0.04-0.04V0.04C0,0.02,0.02,0,0.04,0
        		h1079.93c0.02,0,0.04,0.02,0.04,0.04V1079.96z" />
      </g>
      <g>
        <path className="st1" d="M1062,1061.96c0,0.02-0.02,0.04-0.04,0.04H18.04c-0.02,0-0.04-0.02-0.04-0.04V18.04
        		c0-0.02,0.02-0.04,0.04-0.04h1043.93c0.02,0,0.04,0.02,0.04,0.04V1061.96z" />
      </g>
      <g>
        <path className="st0" d="M303,823.67c0,0.79,0.46,1.89,1.01,2.44l17.87,17.87c0.56,0.56,1.66,1.01,2.44,1.01h61.15
